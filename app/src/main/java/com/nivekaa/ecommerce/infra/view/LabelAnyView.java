package com.nivekaa.ecommerce.infra.view;
...
public class LabelAnyView extends View {
    LabelViewHelper utils;
    public LabelAnyView(Context context) {
        this(context, null);
    }
    public LabelAnyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public LabelAnyView(Context context, AttributeSet attrs, int defStyleAttr) {
